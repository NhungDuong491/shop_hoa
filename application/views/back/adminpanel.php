        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" id="navbar">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">
                    <h1 style ="color:gray"><strong>Trang Admin</strong></h1>
                </a>
            </div>
            <!-- end navbar-header -->
            <!-- navbar-top-links -->
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="<?php echo base_url();?>Login/adminlogout"><i class="fa fa-sign-out fa-fw"></i>Đăng xuất</a>
                        </li>
                    </ul>
                    <!-- end dropdown-user -->
                </li>
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    <li>
                        ...
                        <div class="user-section">
                            <div class="user-section-inner">
                                <img src="<?php echo base_url()?>assets/back/img/trang.jpg" alt="">
                            </div>
                            <div class="user-info">   
                    ...
                    <li class="selected">
                        <a href="<?php echo base_url();?>dashboard"><i class="fa fa-dashboard fa-fw"></i>Thống kê</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url();?>register-form"><i class="fa fa-user-plus fa-fw"></i>Đăng ký người dùng</a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-tags fa-fw"></i> Quản lý danh mục<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                 <a href="<?php echo base_url();?>add-category"><i class=""></i>Thêm danh mục</a>
                             </li>
                             <li>
                                 <a href="<?php echo base_url();?>add-sub-category"><i class=""></i>Thêm danh mục phụ</a>
                             </li>
                            <li>
                                 <a href="<?php echo base_url();?>category-list"><i class=""></i>Danh sách danh mục</a>
                            </li>
                            <li>
                                 <a href="<?php echo base_url();?>sub-category-list"><i class=""></i>Danh sách danh mục phụ</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i>Quản lý kiểu dáng<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="<?php echo base_url();?>add-brand">Thêm kiểu dáng</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url();?>brand-list">Danh sách kiểu dáng</a>
                            </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>
                      <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                 <a href="<?php echo base_url();?>add-product"><i class=""></i>Thêm sản phẩm</a>
                             </li>
                            <li>
                                 <a href="<?php echo base_url();?>product-list"><i class=""></i>Danh sách sản phẩm</a>
                            </li>
                        </ul>
                    </li>
                     <li>
                        <a href="<?php echo base_url()?>manage-order"><i class="fa fa-flask fa-fw"></i>Quản lý đơn hàng</a>
                    </li>
                </ul>
                <!-- end side-menu -->
            </div>
